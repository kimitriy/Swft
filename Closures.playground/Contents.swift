...
//function howAreYou() takes a closure as its parameter
//the closure is of type (String) -> Void i.e. it takes a String as a parameter and returns nothing
//inside of the function body the closure is being called asynchronously 2 seconds later
//thus by the time the closure is being called the function itself is not executing
//nontheless the closure is executing thanks to @escaping keyword in function defenition
...
//in order to save a closure after a function ending up, it may be saved in variable that declared outside of the function
